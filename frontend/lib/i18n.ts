...
const en = {
  ...
  carePartnerWorkspace: "Care Partner",
  ...
  // PCP Workspace
  pcpWorkspace: "PCP Workspace",
  pcpWorkspaceSubtitle: "Primary care view for source-linked patient records.",
  pcpAddPatient: "Add patient",
  pcpMaxTabsReached: "Maximum 8 open patient tabs.",
  pcpMaxTabsBody: "Close a patient tab before opening another.",
  pcpAccessRevoked: "Access to this patient is no longer active.",
  pcpPatientOverview: "Patient overview",
  pcpCareContext: "Care context",
  pcpRecentRecords: "Recent source records",
  pcpLatestLabs: "Latest labs",
  pcpTimelinePreview: "Timeline preview",
  pcpNotes: "Notes",
  pcpDocuments: "Documents",
  pcpOpenFullChart: "Open full patient chart",
  pcpOpenFullTimeline: "Open full timeline",
  pcpSearchApprovedPatients: "Search approved patients",
  pcpCurrentApprovedPatients: "Current approved patients",
  pcpBlockedBody: "This workspace is available only for primary care / family medicine doctors.",
  pcpSpecialistDoctor: "Specialist doctor",
  pcpFamilyDoctor: "Primary care / family medicine doctor",
  pcpSearchMorePatients: "Search more patients",
  pcpNoPatients: "No approved patients yet.",
  pcpQuickActions: "Quick actions",
  pcpActiveAccess: "Active access",
  pcpAddNote: "Add note",
  pcpUploadDocument: "Upload document",
  pcpViewMedications: "View medications",
  pcpViewTimeline: "View timeline",
  pcpNoMedications: "No medications recorded.",
  pcpNoRecentRecords: "No recent records.",
  pcpNoLabs: "No lab results available.",
  pcpNoTimeline: "No timeline events yet.",
  pcpNoNotes: "No notes recorded.",
  pcpDoctorTypeLabel: "Doctor type",
  pcpDoctorTypeHint: "This determines which workspace you get after signing in.",
  pcpOutpatient: "Outpatient follow-up",
  pcpActiveAdmission: "Active admission",
  pcpPastAdmission: "Past admission",
  pcpSourceLinked: "Source-linked",
  pcpPatientEntered: "Patient-entered",
  pcpVerified: "Verified",
  pcpOpenDocument: "Open document",
  pcpOpenNote: "Open note",
  pcpCloseTab: "Close tab",

  // PCP Timeline
  pcpTimeline: "Timeline",
  pcpLongitudinalRecord: "Longitudinal record",
  pcpTimelineSubtitle: "Source-linked patient record over time.",
  pcpAllEvents: "All",
  pcpLabsFilter: "Labs",
  pcpDocumentsFilter: "Documents",
  pcpNotesFilter: "Notes",
  pcpMedicationsFilter: "Medications",
  pcpHospitalizationsFilter: "Hospitalizations",
  pcpImagingFilter: "Imaging",
  pcpOpenSource: "Open source",
  pcpViewAllDocuments: "View all documents",
  pcpViewAllMedications: "View all medications",
  pcpViewAllLabs: "View all labs",
  pcpOpenLabPanel: "Open lab panel",
  pcpNoTimelineEvents: "No source-linked timeline events found in Bragi records.",
  pcpLabPanelSummary: "Lab panel with structured values extracted.",
  pcpMedRecordSummary: "Patient-entered medication record.",
  pcpSourceLinkedEvent: "Source-linked event",
  pcpPatientSnapshot: "Patient snapshot",
  pcpShowMoreEvents: "Show more events",
  pcpEventTypeLab: "Lab panel",
  pcpEventTypeDischarge: "Discharge summary",
  pcpEventTypeImaging: "Imaging report",
  pcpEventTypeNote: "Clinical note",
  pcpEventTypeMedication: "Medication record",
  pcpEventTypeHospitalization: "Hospitalization record",
  pcpEventTypeProcedure: "Procedure report",
  pcpEventTypePathology: "Pathology report",
  pcpEventTypeSource: "Source record",
  pcpEventTypeOther: "Other source record",
  pcpOutOfRange: "Out-of-range value present",
  ...
  // Navigation & shell (design-system phase)
  navMyRecord: "My record",
  navAccount: "Account",
  ...
  navAnalyteGaps: "Analyte gaps",
  navAuditLog: "Audit log",
  navMore: "More",
  navClose: "Close",
  navBack: "Back",
  navOpenMenu: "Open menu",
  navAccountMenu: "Account and preferences",
  navSignedInAs: "Signed in as",
  navPatients: "Patients",
  navSearch: "Search",
  navSwitchPatient: "Switch patient",
  navAllPatients: "All patients",
  navPatientActions: "Patient actions",
  navFilters: "Filters",
  navApply: "Apply",
  navClear: "Clear",
  navSort: "Sort",
  navResults: "results",
  navNoResults: "No results",
  navLoading: "Loading…",
  navRetry: "Retry",
  navSomethingWrong: "Something went wrong",
  navChange: "Change",
  navSignInAs: "Sign in as",
  navAbout: "About",
} as const;
...
const ro: Record<keyof typeof en, string> = {
  ...
  // PCP Workspace
  pcpWorkspace: "Spațiu de lucru medic de familie",
  pcpWorkspaceSubtitle: "Vizualizare de medicină de familie pentru înregistrări legate de sursă.",
  pcpAddPatient: "Adaugă pacient",
  pcpMaxTabsReached: "Maximum 8 file de pacienți deschise.",
  pcpMaxTabsBody: "Închide o filă de pacient înainte de a deschide alta.",
  pcpAccessRevoked: "Accesul la acest pacient nu mai este activ.",
  pcpPatientOverview: "Prezentare pacient",
  pcpCareContext: "Context îngrijire",
  pcpRecentRecords: "Înregistrări sursă recente",
  pcpLatestLabs: "Analize recente",
  pcpTimelinePreview: "Previzualizare cronologie",
  pcpNotes: "Note",
  pcpDocuments: "Documente",
  pcpOpenFullChart: "Deschide fișa completă a pacientului",
  pcpOpenFullTimeline: "Deschide cronologia completă",
  pcpSearchApprovedPatients: "Caută pacienți aprobați",
  pcpCurrentApprovedPatients: "Pacienți aprobați curent",
  pcpBlockedBody: "Acest spațiu de lucru este disponibil doar pentru medici de familie / medicină primară.",
  pcpSpecialistDoctor: "Medic specialist",
  pcpFamilyDoctor: "Medic de familie / medicină primară",
  pcpSearchMorePatients: "Caută mai mulți pacienți",
  pcpNoPatients: "Nu există pacienți aprobați încă.",
  pcpQuickActions: "Acțiuni rapide",
  pcpActiveAccess: "Acces activ",
  pcpAddNote: "Adaugă notă",
  pcpUploadDocument: "Încarcă document",
  pcpViewMedications: "Vezi medicamente",
  pcpViewTimeline: "Vezi cronologie",
  pcpNoMedications: "Nu sunt medicamente înregistrate.",
  pcpNoRecentRecords: "Nu există înregistrări recente.",
  pcpNoLabs: "Nu sunt disponibile rezultate de laborator.",
  pcpNoTimeline: "Nu există evenimente în cronologie.",
  pcpNoNotes: "Nu sunt note înregistrate.",
  pcpDoctorTypeLabel: "Tip doctor",
  pcpDoctorTypeHint: "Aceasta determină ce spațiu de lucru primești după autentificare.",
  pcpOutpatient: "Monitorizare ambulatorie",
  pcpActiveAdmission: "Internare activă",
  pcpPastAdmission: "Internare anterioară",
  pcpSourceLinked: "Legat de sursă",
  pcpPatientEntered: "Introdus de pacient",
  pcpVerified: "Verificat",
  pcpOpenDocument: "Deschide document",
  pcpOpenNote: "Deschide notă",
  pcpCloseTab: "Închide fila",

  // PCP Timeline
  pcpTimeline: "Cronologie",
  pcpLongitudinalRecord: "Înregistrare longitudinală",
  pcpTimelineSubtitle: "Înregistrare pacient legată de surse în timp.",
  pcpAllEvents: "Toate",
  pcpLabsFilter: "Analize",
  pcpDocumentsFilter: "Documente",
  pcpNotesFilter: "Note",
  pcpMedicationsFilter: "Medicație",
  pcpHospitalizationsFilter: "Spitalizări",
  pcpImagingFilter: "Imagistică",
  pcpOpenSource: "Deschide sursa",
  pcpViewAllDocuments: "Vezi toate documentele",
  pcpViewAllMedications: "Vezi toate medicamentele",
  pcpViewAllLabs: "Vezi toate analizele",
  pcpOpenLabPanel: "Deschide setul de analize",
  pcpNoTimelineEvents: "Nu au fost găsite evenimente de cronologie legate de surse în Bragi.",
  pcpLabPanelSummary: "Set de analize cu valori structurate extrase.",
  pcpMedRecordSummary: "Înregistrare medicație introdusă de pacient.",
  pcpSourceLinkedEvent: "Eveniment legat de sursă",
  pcpPatientSnapshot: "Rezumat pacient",
  pcpShowMoreEvents: "Arată mai multe evenimente",
  pcpEventTypeLab: "Set de analize",
  pcpEventTypeDischarge: "Bilet de externare",
  pcpEventTypeImaging: "Raport imagistic",
  pcpEventTypeNote: "Notă clinică",
  pcpEventTypeMedication: "Document medicație",
  pcpEventTypeHospitalization: "Înregistrare spitalizare",
  pcpEventTypeProcedure: "Raport procedură",
  pcpEventTypePathology: "Raport anatomopatologic",
  pcpEventTypeSource: "Alt document sursă",
  pcpEventTypeOther: "Alt document sursă",
  pcpOutOfRange: "Valoare în afara intervalului prezentă",
  ...
  // Navigation & shell (design-system phase)
  navMyRecord: "Dosarul meu",
  navAccount: "Cont",
  navOperations: "Operațiuni",
  navQuality: "Calitatea datelor",
  navOverview: "Prezentare",
  navTimeline: "Cronologie",
  navLabs: "Analize",
  navDocuments: "Documente",
  navMedications: "Medicație",
  navAnalytics: "Analiză",
  navAdmissions: "Internări",
  navAnalyteGaps: "Analiți lipsă",
  navAuditLog: "Jurnal de audit",
  navMore: "Mai mult",
  navClose: "Închide",
  navBack: "Înapoi",
  navOpenMenu: "Deschide meniul",
  navAccountMenu: "Cont și preferințe",
  navSignedInAs: "Autentificat ca",
  navPatients: "Pacienți",
  navSearch: "Caută",
  navSwitchPatient: "Schimbă pacientul",
  navAllPatients: "Toți pacienții",
  navPatientActions: "Acțiuni pacient",
  navFilters: "Filtre",
  navApply: "Aplică",
  navClear: "Șterge",
  navSort: "Sortare",
  navResults: "rezultate",
  navNoResults: "Niciun rezultat",
  navLoading: "Se încarcă…",
  navRetry: "Reîncearcă",
  navSomethingWrong: "A apărut o eroare",
  navChange: "Schimbă",
  navSignInAs: "Autentifică-te ca",
  navAbout: "Despre"
};
